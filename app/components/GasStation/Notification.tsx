  ...
  return (
    ...
    >
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M10 0C4.47715 0 0 4.47715 0 10C0 15.5228 4.47715 20 10 20C15.5228 20 20 15.5228 20 10C20 4.47715 15.5228 0 10 0ZM13.774 8.1333C14.1237 7.70582 14.0607 7.0758 13.6332 6.72607C13.2058 6.37635 12.5758 6.43935 12.226 6.86679L8.4258 11.5116L7.20711 10.2929C6.81658 9.9024 6.18342 9.9024 5.79289 10.2929C5.40237 10.6834 5.40237 11.3166 5.79289 11.7071L7.79289 13.7071C7.99267 13.9069 8.2676 14.0129 8.5498 13.9988C8.832 13.9847 9.095 13.8519 9.274 13.6333L13.774 8.1333Z"
        fill="#74FF71"
      />
    </svg>
  );
...
const NOTIFICATION_TYPE_TO_ICON: Record<
  Exclude<NotificationProps["type"], undefined>,
  React.ReactNode
> = {
  pending: (
...
export const Notification: React.FC<NotificationProps> = ({
  ...
  return (
    <div
      className={
        "flex rounded-[70px] items-center gap-[10px] border-[1px] border-[#ffffff1a] px-[15px] py-[10px] " +
        classNames
      }
    >
...
export const GasStationNotification: React.FC<{
  txState: string;
  txStatus: TxStatus;
  txId: string;
}> = ({ txState, txStatus, txId }) => {
  ...
  return (
    <Notification
      type={type}
      title={txState}
      classNames="mt-[-111px] bg-[#ffffff0d] h-[46px]"
    >
      {txId && (
        <a
          className="text-[#ffffff4d] text-[16px] font-medium transition-all hover:text-[#4779ff]"
          href={composeEclipsescanUrl(
            selectedOption,
            composeEtherscanCompatibleTxPath(txId),
          )}
          target="_blank"
        >
