  ...
  return (
    <footer className="flex items-center" style={{ height: "auto" }}>
      <div className="flex flex-row legal-footer justify-center">
        <a href="https://www.eclipse.xyz/terms" target="_blank">
          {" "}
          Terms & Conditions{" "}
        </a>
        <a href="https://www.eclipse.xyz/privacy-policy" target="_blank">
          {" "}
          Privacy Policy{" "}
        </a>
        <a href="https://docs.eclipse.xyz" target="_blank">
          {" "}
          Docs{" "}
        </a>
        <a href="https://discord.gg/eclipse-fnd" target="_blank">
          {" "}
          Discord{" "}
        </a>
      </div>
        ...
        <div className="ml-[28px] flex flex-row items-center gap-2">
          ...
          {gasPrice ? (
            <span
              ...
              style={{ color: "rgba(161, 254, 160, 0.5)" }}
            >
              {gasPrice}
